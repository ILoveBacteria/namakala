...
public class SampleData {
    public static void main(String[] args) {
        ...
        Product p4 = new Product(++Database.countProduct, "iPhone 13 mini", "assets/images/iphone13.png", "This product is in Test!", 899, "Mobiles", new Market("Digikala"), 0, new ArrayList<>(Collections.singletonList(0xFF2196F3)), new ArrayList<>(Arrays.asList("128GB", "256GB")));
        Product p5 = new Product(++Database.countProduct, "Macbook Air", "assets/images/macbook.png", "This product is in Test!", 999, "Laptops", new Market("Digikala"), 3, new ArrayList<>(Collections.singletonList(0xFF9E9E9E)), new ArrayList<>(Collections.singletonList("default")));
        Product p6 = new Product(++Database.countProduct, "Macbook Pro M1", "assets/images/macbook.png", "This product is in Test!", 1199, "Laptops", new Market("Digikala"), 2, new ArrayList<>(Collections.singletonList(0xFF9E9E9E)), new ArrayList<>(Collections.singletonList("default")));
